...
{
    /// <summary>
    /// Interaction logic for NewOwnerPage.xaml
    /// </summary>
    public partial class NewOwnerPage : Page
    {
        private UsersWindow parent;
        private UserController userController;
        public NewOwnerPage(UsersWindow parent)
        {
            InitializeComponent();
            this.parent = parent;
        ...
        private void Confirm_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            if (userController.Register(new User(JMBGInput.Text, EmailInput.Text, PasswordInput.Password, NameInput.Text, SurnameInput.Text, PhoneInput.Text, "OWNER", false)))
            {
